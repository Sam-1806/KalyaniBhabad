...
const postData: DataType[] = [
    {
        ...
        imgSrc: '/images/featured/article-m1.png',
    },
    {
        heading: ' ',
        imgSrc: '/images/featured/article-m2.png',
    },
    {
        heading: 'Seminars conducted on various topics',
        imgSrc: '/images/featured/article-m3.png',
    },
    {
        heading: 'News Paper articles',
        imgSrc: '/images/featured/article-m4.png',
    }
]
                            ...
                            <div key={i}>
                                <div className='bg-transparent m-3 pb-12 my-10 rounded-3xl'>
                                    <Image
                                        ...
                                        objectFit="cover" // Ensures images cover the specified dimensions
